...
The result of the operation is calculated and displayed in the read-only result box.
If the input is invalid (non-numeric) or the user tries to divide by zero, an error message is displayed.
